...
## Calculating insolation and topographic wetness index.using SAGA
...
We can also calculate a topographic wetness index. These two calculations tgether will take several minutes to run, but the layers may be useful.
...
system ("saga_cmd ta_hydrology 15 -DEM gis_data/saga_dtm.sgrd  -TWI   gis_data/saga_TWI")

sol<-raster("gis_data/saga_sol.sdat")
twi<-raster("gis_data/saga_TWI.sdat")

sol@crs<-dtm@crs
twi@crs<-dtm@crs

writeRaster(sol,"gis_data/sol.tif",format="GTiff", overwrite=TRUE)
writeRaster(twi,"gis_data/twi.tif",format="GTiff", overwrite=TRUE)
